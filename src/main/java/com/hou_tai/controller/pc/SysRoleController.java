...
public class SysRoleController {
    ...
    public ResultVO<PageResult<SysRoleVO>> pageList(@ParameterObject PageDaoEntity reqDTO){
        ...
        return ResponseData.success(new PageResult<>(BeanUtil.copyToList(page.getRecords(), SysRoleVO.class), page.getTotal()));
    }
    ...
    public ResultVO<List<Integer>> getRoleMenuIds(@RequestParam("roleId") Integer roleId){
        return ResponseData.success(sysRoleMenuService.getRoleMenuIds(roleId));
    }
    ...
    public ResultVO<List<SysRoleVO>> listAllRole(){
        ...
        return ResponseData.success(BeanUtil.copyToList(list, SysRoleVO.class));
    }
